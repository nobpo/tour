...
<center> 
     <a href="index.php" target=_blank><img src="http://localhost/tourist_attraction/public/img/banner.png" border=0 height=300 width=900 alt="ข้อความ"></a> 
 </center> 
...
<div class="row">  
<div class="span8">    
<ul style='color:white !important;' class="nav nav-pills nav-justified"> 
...
<div class="span3"; style="margin:0px 0px 20px 300px; width:150px"> 
	<?php 
		if(!Session::get('user')) echo '
			...
			echo '<h3 style="width: 600px">ยินดีต้อนรับ คุณ '. $user->name_first . ' ' . $user->name_last . '</h3>';
...
<div class="container-left1">
	<img src="<?php echo $data[$rank[0]-1]->Tour_pic ?>" style="border-radius:40px"/>
</div>
...
<div class="row-fluid" style="width: 900px; margin:20px;">
	...
	<div class="span4" style="background-color: rgb(230,230,230); border: 2px solid gray; border-radius:5px; padding: 5px; height: 300px">
		<?php 			
            ...
            if(is_null($data[$rank[0]-1]->Tour_pic)) echo '<img src="http://placehold.it/900x300" class="img-responsive">';
            else echo "<img src='".$data[$rank[0]-1]->Tour_pic."'/>" ;   
            echo substr($data[$rank[0]-1]->Description, 0, 200) . "..."; 	
